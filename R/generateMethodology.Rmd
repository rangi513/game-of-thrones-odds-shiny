...
$$Expected\ Death\ Pool\ Points = \sum_{n=1}^{k} \begin{cases}
     \Big( \big(3 \times \frac{1}{6-current\ episode} + 1 \times \big(1-\frac{1}{6-current\ episode}\big)\big) \times Vegas\ Implied\ Probability\ To\ Die_{n} \Big) - 1 \times \Big((1 - Vegas\ Implied\ Probability\ To\ Die_{n})\Big), & if\ Predicted\ Episode\ of\ Death_{n} > current\ episode  \\
     \Big(1 \times Vegas\ Implied\ Probability\ To\ Die_{n} \big) - 1 \times \big((1 - Vegas\ Implied\ Probability\ To\ Die_{n}) \Big),              & if\ Predicted\ Episode\ of\ Death_{n} \leq current\ episode  \\
     0,  & \text{otherwise (predicted survival)}
\end{cases}
$$
