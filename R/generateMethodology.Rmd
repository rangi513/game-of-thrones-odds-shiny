...
$$Expected\ Death\ Pool\ Points = \sum_{n=1}^{k} \cases{
     \Big( \big(3 \times \frac{1}{6-current\ episode} + 1 \times \big(1-\frac{1}{6-current\ episode}\big)\big) \times Vegas\ Implied\ Probability\ To\ Die_{n} \Big) - 1 \times \Big((1 - Vegas\ Implied\ Probability\ To\ Die_{n})\Big), & if Predicted Episode of Death > current episode  \cr
